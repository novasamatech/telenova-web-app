        ...
        <ModalContent>
          ...
          {giftStatus !== null ? (
            ...
            <>
              ...
              <Shimmering width={220} height={15} className="mx-auto mt-4" />
              <Shimmering width={150} height={15} className="mx-auto my-4" />
              <Shimmering width={220} height={15} className="mx-auto mb-4" />
            </>
          )}
        </ModalContent>
      </Modal>
